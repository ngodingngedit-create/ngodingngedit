    ...
    <div class="legal-body container">
      ...
      <article class="legal-content">
        ...
        <section id="pendahuluan" class="legal-section">
          <h2>1. Pendahuluan</h2>
          <p>Dokumen Syarat &amp; Ketentuan ini mengatur hak, kewajiban, serta ketentuan penggunaan layanan jasa pembuatan coding, editing, desain, dan layanan digital lainnya.</p>
        ...
        <section id="definisi" class="legal-section">
          ...
          <ul>
            ...
            <li><strong>"Proyek"</strong> mengacu pada pekerjaan yang telah disepakati.</li>
            <li><strong>"Revisi"</strong> adalah perubahan minor yang masih sesuai dengan brief awal.</li>
            <li><strong>"Source Code"</strong> adalah file kode program hasil pengerjaan proyek.</li>
          </ul>
        </section>
        ...
        <section id="pemesanan" class="legal-section">
          ...
          <ul>
            <li>Klien wajib memberikan brief proyek secara jelas dan lengkap.</li>
            <li>Klien bertanggung jawab atas legalitas data dan materi yang diberikan.</li>
            <li>Pengerjaan dimulai setelah pembayaran DP diterima.</li>
            <li>Estimasi pengerjaan dihitung setelah seluruh kebutuhan proyek diterima lengkap.</li>
        ...
        <section id="pembayaran" class="legal-section">
          ...
          <ul>
            ...
            <li>Pembayaran yang sudah dilakukan bersifat <strong>non-refundable</strong> kecuali terdapat kesepakatan khusus.</li>
          </ul>
        </section>
        ...
        <section id="revisi" class="legal-section">
          ...
          <ul>
            ...
            <li>Perubahan konsep besar dari brief awal dianggap pekerjaan tambahan.</li>
            <li>Revisi tambahan di luar ketentuan dapat dikenakan biaya tambahan.</li>
            <li>Permintaan revisi harus dilakukan dalam batas waktu yang telah ditentukan.</li>
          </ul>
        </section>
        ...
        <section id="waktu-pengerjaan" class="legal-section">
          ...
          <ul>
            <li>Estimasi pengerjaan bersifat perkiraan.</li>
        ...
        <section id="perubahan-ketentuan" class="legal-section">
          ...
          <p>Syarat &amp; Ketentuan ini dapat diperbarui sewaktu-waktu tanpa pemberitahuan sebelumnya. Versi terbaru akan menjadi acuan yang berlaku.</p>
        </section>

        <section id="persetujuan" class="legal-section">
          <h2>20. Persetujuan</h2>
          <p>Dengan melakukan pembayaran atau menggunakan layanan kami, klien dianggap menyetujui seluruh Syarat &amp; Ketentuan yang berlaku.</p>
        </section>
        ...
        <div class="legal-back">
          ...
          <router-link to="/privacy-policy" class="legal-back__btn legal-back__btn--alt">
