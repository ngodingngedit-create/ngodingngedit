  ...
  <main class="legal-page">
    <div class="legal-hero">
      <div class="legal-hero__inner container">
        <h1 class="legal-hero__title">{{ $t('terms.title') }}</h1>
        <p class="legal-hero__subtitle" v-html="$t('terms.subtitle')"></p>
      </div>
    </div>
    ...
    <div class="legal-body container">
      ...
      <aside class="legal-toc">
        <p class="legal-toc__label">{{ $t('terms.tocLabel') }}</p>
        <nav>
...
const tocItems = computed(() => tm('terms.toc'))
